...
public final class FragmentDiet1Binding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentDiet1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentDiet1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_diet1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentDiet1Binding bind(@NonNull View rootView) {
